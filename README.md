# Breakout
Classical breakout game in ownCloud

Place this app in **owncloud/apps/**

Based on the Breakout game from [Jake Gordon](https://github.com/jakesgordon/javascript-breakout)
...
A HTML5 experiment to implement BREAKOUT in a `<canvas>`
